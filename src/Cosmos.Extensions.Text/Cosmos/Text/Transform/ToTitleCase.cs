...
internal class ToTitleCase : ICulturedStringTransformer
{
    ...
    public string Transform(string input, CultureInfo culture)
    {
        ...
        foreach (Match word in matches)
        {
            ...
            {
                result = ReplaceWithTitleCase(word, result, culture, ref firstWord);
            }
    ...
    private static string ReplaceWithTitleCase(Match word, string source, CultureInfo culture, ref bool firstWord)
    {
    ...
    public static ToTitleCase Instance { get; } = new();
}