...
namespace Cosmos.Validations
{
    ...
    public partial class ValidationResultCollection
    {
        ...
        public ValidationResultCollection(SystemResult result) : this()
        {
            if (result is null)
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ValidationResultCollection(SystemResult result, string strategyName) : this()
        {
            if (result is null)
                throw new ArgumentNullException(nameof(result));
            var unionResult = result.ToUnionResult();
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ValidationResultCollection(IEnumerable<SystemResult> results) : this()
        {
            if (results is null)
        ...
        /// <param name="strategyName"></param>
        /// <exception cref="ArgumentNullException"></exception>
        public ValidationResultCollection(IEnumerable<SystemResult> results, string strategyName) : this()
        {
            if (results is null)
                throw new ArgumentNullException(nameof(results));
            var unionResults = results.Select(result => result.ToUnionResult()).ToList();
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ValidationResultCollection(DataAnnotationValidationResultCollection collection) : this()
        {
        ...
        private void UpdateResultFlaggedByStrategy(string name, List<SystemResult> results)
        {
